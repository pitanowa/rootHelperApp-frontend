                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', gap: 16, flexWrap: 'wrap' }}>
                    <div style={{ minWidth: 280, flex: '1 1 520px' }}>
                        ...
                        <div style={ui.heroText}>
                            Ta aplikacja pozwala szybko zarządzać graczami, grupami i rozgrywkami. Tworzysz mecze, śledzisz status, a w
                            trakcie rozgrywki ogarniasz draft ras i timer — bez chaosu w notatkach i excelach.
                        </div>
                                    ...
                                    {standings.map((r, idx) => {
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                <div style={{ textAlign: 'right', fontWeight: 1000, fontVariantNumeric: 'tabular-nums' }}>
                                                    {r.pointsTotal}
                                                </div>
                                            </div>
                                        )
                                    ...
                                    {activeMatches.map((m) => (
                                        ...
                                        >
                                            ...
                                            <div style={{ display: 'flex', alignItems: 'center', gap: 8, flexWrap: 'wrap', justifyContent: 'flex-end' }}>
                                                ...
                                                {m.ranked != null && <span style={ui.tag(m.ranked ? 'ranked' : 'casual')}>{m.ranked ? '🏅 Ranked' : '🍻 Casual'}</span>}
                                            </div>
                                        </Link>
                                    ))}
                                </div>
